...
Public Class CrystalReportDia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VSCYRM.CrystalReportDia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportDia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportDia = New CrystalReportDia()
        rpt.Site = Me.Site
        Return rpt
    End Function
